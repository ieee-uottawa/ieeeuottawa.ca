...
function ChevronDownIcon(props) {
  return (
    <Icon {...props} path="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" />
  );
}

function ChevronUpIcon(props) {
  return (
    <Icon {...props} path="M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z" />
  );
}
...
export { FlaskIcon, LeadPencilIcon, LightBulbIcon, ChevronDownIcon, ChevronUpIcon };
