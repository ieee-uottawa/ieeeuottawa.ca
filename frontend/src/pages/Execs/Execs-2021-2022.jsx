...
const Execs_2021_2022 = () => (
    <StaticQuery
        query={graphql`
            query {
                allExecs20212022Json {
                    nodes {
                        name
                        position
                        email
        ...
        `}
        render={({
            allExecs20212022Json: { nodes },
            allComs20212022Json: { edges }
        }) => {
            return (
                <div>
...
export default Execs_2021_2022;
