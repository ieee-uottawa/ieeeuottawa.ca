...
const Execs_2022_2023 = () => (
    <StaticQuery
        query={graphql`
            query {
                allExecs20222023Json {
                    nodes {
                        name
                        position
                        email
        ...
        `}
        render={({
            allExecs20222023Json: { nodes },
            allComs20222023Json: { edges }
        }) => {
            return (
                <div>
...
export default Execs_2022_2023;
