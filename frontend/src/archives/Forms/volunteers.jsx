    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    <strong>
                        Looking to get more involved with the IEEE uOttawa
                        Student Branch?
                    </strong>
                </Typography>
                <Typography
                ...
                >
                    <strong>
                        Sign-Up below to be a volunteer to one of the many
                        events we hold throughout the school year!
                    </strong>
                </Typography>
                {!isLoading && (
                    <Form
